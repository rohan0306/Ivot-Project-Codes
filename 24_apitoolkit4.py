...
fix_cost_per_unit = fix_cost_per_quarter / units_sold_quarterly

total_cost_per_unit = fix_cost_per_unit +  var_cost_per_unit
...
final_output["units_sold_monthly"] = $$request["units_sold_monthly"]
final_output["units_sold_quarterly"] = $$request["units_sold_quarterly"]
final_output["units_sold_yearly"] = $$request["units_sold_yearly"]
