...
cogs_sales_baseline = round(acogs_sales_baseline)
...
cog_sold_forecast = math.ceil(acog_sold_forecast)
...
gross_profit_forecast = math.floor(agross_profit_forecast)
...
operating_profit_forecast = math.ceil(aoperating_profit_forecast)

aoperating_margin_forecast	= operating_profit_forecast / sales_forecast
operating_margin_forecast	= round(aoperating_margin_forecast * 100)

atax_forecast = operating_profit_forecast * 0.21
tax_forecast = math.ceil(atax_forecast)
aquarterly_operating_cash_forecast = operating_profit_forecast - atax_forecast +  depreciation
quarterly_operating_cash_forecast = math.floor(aquarterly_operating_cash_forecast)
annual_cash_flow_forecast = aquarterly_operating_cash_forecast * 4
cash_flow_value_forecast = annual_cash_flow_forecast / 0.04
...
implied_forecast = round(aimplied_forecast)  # Gives 28.8
