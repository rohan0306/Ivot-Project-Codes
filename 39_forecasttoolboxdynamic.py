...
extra_fully_q3_24 = round(aextra_fully_q3_24)                           
...
longterm_debt_quarter_23 = round(alongterm_debt_quarter_23) 


acash_and_cash_quarter_24 = float($$raw_finance_24[0]["Cash_and_Cash_Equivalents_m"]) 
cash_and_cash_quarter_24 = round(acash_and_cash_quarter_24)

alongterm_invest_quarter_24 = float($$raw_finance_24[0]["Longterm_Investments_m"])
longterm_invest_quarter_24 = round(alongterm_invest_quarter_24)
                                   
alongterm_debt_quarter_24 = float($$raw_finance_24[0]["Longterm_Debt_m"]) 
longterm_debt_quarter_24 = round(alongterm_debt_quarter_24) 
...
cogs_quarter_24 = round($$raw_finance_24[0]["Total_CostofGoods_m"]) 
                        
ageneral_admin_quarter_23 = float($$raw_finance_23[0]["General__Administrative_m"])
general_admin_quarter_23 = round(ageneral_admin_quarter_23) 
...
other_quarter_23 = round(aother_quarter_23) 

adepreciation_quarter_23  = float($$raw_finance_23[0]["Depreciation_m"])
depreciation_quarter_23 = round(adepreciation_quarter_23) 
...
other_quarter_24 = round(aother_quarter_24) 

adepreciation_quarter_24  = float($$raw_finance_24[0]["Depreciation_m"])
depreciation_quarter_24 = round(adepreciation_quarter_24) 
...
percent_sales_quarter_23 = round(apercent_sales_quarter_23,1)
...
percent_sales_quarter_24 = round(apercent_sales_quarter_24,1)
...
operating_profit_quarter_23  = round(aoperating_profit_quarter_23)
...
operating_profit_quarter_24 = round(aoperating_profit_quarter_24)
...
quarterly_operating_quarter_24 = round(aquarterly_operating_quarter_24)
...
operating_profit_quarter_27 = round(aoperating_profit_quarter_27)
...
quarterly_operating_quarter_27 = round(aquarterly_operating_quarter_27)

operating_cash_quarter_23 = round((extra_q1_quarter_23 / extra_q1_quarter_22 - 1) * 100)

operating_cash_quarter_24 = round((aquarterly_operating_quarter_24 / aquarterly_operating_quarter_23 - 1) * 100,1)
...
cash_flow_value_quarter_23 = round(acash_flow_value_quarter_23)
...
enterprise_value_quarter_23 = round(aenterprise_value_quarter_23)
aenterprise_quarter_23 = aenterprise_value_quarter_23 / extra_fully_q3_22 #Quarterlies
enterprise_quarter_23 = round(aenterprise_quarter_23)
...
cash_flow_value_quarter_24 = round(acash_flow_value_quarter_24)
...
enterprise_value_quarter_24 = round(aenterprise_value_quarter_24)
aenterprise_quarter_24 = aenterprise_value_quarter_24 / aextra_fully_q3_24 #Quarterlies
enterprise_quarter_24 = round(aenterprise_quarter_24)
...
cash_flow_value_quarter_27 = round(acash_flow_value_quarter_27)
...
enterprise_value_quarter_27 = round(aenterprise_value_quarter_27)
aenterprise_quarter_27 = aenterprise_value_quarter_27 / aextra_fully_q3_24 #Quarterlies
enterprise_quarter_27 = round(aenterprise_quarter_27)

implied_quarter_23 = round((aenterprise_quarter_23 / price_value - 1) * 100,1)
implied_quarter_24 = round((aenterprise_quarter_24 / price_value - 1) * 100,1)
implied_quarter_27 = round((aenterprise_quarter_27 / price_value - 1) * 100,1)
...
operating_margin_quarter_23 = round((aoperating_profit_quarter_23 / asales_quarter_23) * 100,1)

operating_margin_quarter_24 = round((aoperating_profit_quarter_24 / asales_quarter_24) * 100,1)

operating_margin_quarter_27 = round((aoperating_profit_quarter_27 / asales_quarter_27) * 100,1) 


growth_rate_quarter_24  = round((asales_quarter_24 / asales_quarter_23 - 1) * 100,1)
#growth_rate_quarter_24 = math.ceil(agrowth_rate_quarter_24)

#cogs_quarter_27 =  sales_quarter_27 * percent_sales_quarter_27


gross_margin_quarter_23 = round((agross_profit_quarter_23 / asales_quarter_23) * 100,1)
gross_margin_quarter_24 = round((agross_profit_quarter_24 / asales_quarter_24) * 100,1)
gross_margin_quarter_27 = round((agross_profit_quarter_27 / asales_quarter_27) * 100,1)
...
final_output["fully_diluted_quarter_23"] = round($$raw_finance_q3_22[0]["Fully_diluted_shares_outstanding_m"])
...
final_output["growth_rate_quarter_27"] = $$request["growth_rate_quarter_27"]
final_output["percent_sales_quarter_27"] = $$request["percent_sales_quarter_27"]
...
response_str = cache["response"]

# Handle case where response might have extra braces
if isinstance(response_str, str):
    response_str = response_str.strip("{} ")  # Remove outer {{ }}
...
Company_Symbol = cache["Company_Symbol"]
cardstatus = "Active"
...
# Store back to cache
cache["combined_data"] = combined_data
